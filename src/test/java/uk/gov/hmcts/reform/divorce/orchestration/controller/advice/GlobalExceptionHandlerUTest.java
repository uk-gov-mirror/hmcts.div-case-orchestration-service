...
public class GlobalExceptionHandlerUTest {
    ...
    private final GlobalExceptionHandler classUnderTest = new GlobalExceptionHandler();//TODO - write a test for exposing the case id in case orchestration exceptions
